...
async function seed() {
  ...
  const sampleProfiles = [
    { name: 'Arjun Mehta', email: 'arjun.mehta@example.com', role: 'student', title: 'Lead Architect' },
    { name: 'Priya Sharma', email: 'priya.sharma@example.com', role: 'faculty', title: 'Academic Advisor' },
    { name: 'Vikram Nair', email: 'vikram.nair@example.com', role: 'reviewer', title: 'Security Auditor' },
    { name: 'Sneha Reddy', email: 'sneha.reddy@example.com', role: 'student', title: 'Data Engineer' }
  ];
  ...
  const { data: profs, error: pErr } = await supabase.from('profiles').select('id, full_name, email, role, onboarded');
