...
function StudioDashboard() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Featured AI Website Generator Banner */}
      <div className="p-5 rounded-2xl border border-cyan-500/40 bg-gradient-to-r from-cyan-950/40 via-card to-blue-950/30 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 shadow-lg shadow-cyan-500/5">
        <div className="flex items-center gap-3.5">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h2 className="text-base font-bold text-foreground">AI-Driven Website Generation Studio</h2>
              <span className="text-[10px] uppercase font-mono px-2 py-0.5 rounded-full border border-cyan-500/40 bg-cyan-500/10 text-cyan-400 font-semibold">New</span>
            </div>
            <p className="text-xs text-muted-foreground mt-1 max-w-xl">
              Describe your vision in natural language. Configure visual design tokens, compare scored tech stacks, synthesize frontend & backend blueprints, and explore live sandboxed previews.
            </p>
          </div>
        </div>
        <Button asChild className="shrink-0 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-black font-semibold shadow-md">
          <Link to="/app/studio/create-website">
            Launch Website Generator <ArrowRight className="ml-1 size-4" />
          </Link>
        </Button>
      </div>
