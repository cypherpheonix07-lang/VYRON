...
function IntegrationStudioPage() {
  ...
  return (
    <div className="space-y-8">
      {/* Primary Project GitHub Multi-Account & Repo Binding System */}
      <ProjectGitHubIntegrationHub projectId={id} />
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pt-4 border-t border-border/50">
        <div>
          <h2 className="text-base font-semibold flex items-center gap-2">
            <Cable className="size-4 text-primary" /> Auxiliary Services &amp; Pipelines
          </h2>
          <p className="text-xs text-muted-foreground mt-0.5">
            Configure external database endpoints, AI gateways, and third-party webhooks.
          </p>
        </div>
