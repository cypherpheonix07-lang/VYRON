...
export function StatusBadge({ status }: { status: string }) {
  const map: Record<string, string> = {
    ...
    Draft: "border-amber-500/40 bg-amber-500/10 text-amber-400 border-dashed",
    "Draft (Wizard)": "border-amber-500/40 bg-amber-500/10 text-amber-400 border-dashed",
    "draft-wizard": "border-amber-500/40 bg-amber-500/10 text-amber-400 border-dashed",
    ...
    Strict: "border-rose-500/40 bg-rose-500/15 text-rose-400",
    "strict-gate": "border-rose-500/40 bg-rose-500/15 text-rose-400",
    Standard: "border-sky-500/40 bg-sky-500/15 text-sky-400",
    Advisory: "border-amber-500/40 bg-amber-500/15 text-amber-400",
    "custom-audience": "border-violet-500/40 bg-violet-500/15 text-violet-400",
  };
  return (
